<div class=" mb-3 fg-form-col col-md-12">
    <div class="fg-location-picker cardd shadoww container mb-3" data-fg-title="Location">
        <label class="form-label"><i class="fa fa-map-marker-alt"></i> Location</label>
        <input type="hidden" name="location[id]" value="155">
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    <div class=" mb-3 fg-form-col col-md-12">
                        <label for="input" class="form-label"><i class="fa fa-"></i> Location name</label>
                        <input type="text" name="location[name]" value="مجمعات الخليج"
                            class="form-control form-control fg-location-name" id="input">
                    </div>
                    <div class=" mb-3 fg-form-col col-md-12">
                        <label for="input" class="form-label"><i class="fa fa-"></i> Address</label>
                        <input type="text" name="location[address]" value="mulham, Riyadh Region, Saudi Arabia"
                            class="form-control form-control fg-location-address" id="input">
                    </div>
                    <div class=" mb-3 fg-form-col col-md-12">
                        <label for="input" class="form-label"><i class="fa fa-"></i> Latitude</label>
                        <input type="text" name="location[latitude]" value="25.146371208651"
                            class="form-control form-control fg-location-latitude" id="input">
                    </div>
                    <div class=" mb-3 fg-form-col col-md-12">
                        <label for="input" class="form-label"><i class="fa fa-"></i> Longitude</label>
                        <input type="text" name="location[longitude]" value="46.332091859375"
                            class="form-control form-control fg-location-longitude" id="input">
                    </div>
                    <div class=" mb-3 fg-form-col col-md-12">
                        <label for="" class="form-label"><i class="fa fa-"></i> Description</label>
                        <textarea name="location[description]" class="form-control form-control fg-location-description" id="">مجمعات الخليج, Tuwayq District, Namar Municipality, Riyadh governorate, Riyadh Region, 14928, Saudi Arabia</textarea>
                    </div>
                </div><!-- row -->
            </div>
            <div class="col-md-6">
                <div class="position-relative">
                    <div id="fg-location-map" class="fg-location-map"
                        ...
                        <div
                            ...
                            <div tabindex="0" aria-label="Map" aria-roledescription="map" role="region"
                                aria-describedby="B4182D34-B90B-4E98-8F54-7CFCEB79C779"
                                style="position: absolute; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; left: 0px; top: 0px;">
                                <div id="B4182D34-B90B-4E98-8F54-7CFCEB79C779" style="display: none;">
                            ...
                            <div class="gm-style"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                                                <div
                                                    style="position: absolute; z-index: 992; transform: matrix(1, 0, 0, 1, -242, -132);">
                                                    <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i161!3i109!4i256!2m3!1e0!2sm!3i692438032!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=127347"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: 0px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i160!3i109!4i256!2m3!1e0!2sm!3i692438129!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=67316"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: 512px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i162!3i110!4i256!2m3!1e0!2sm!3i692438032!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=124661"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: 512px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i162!3i109!4i256!2m3!1e0!2sm!3i692438032!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=81634"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: 256px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i161!3i110!4i256!2m3!1e0!2sm!3i692438032!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=39303"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: 0px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i160!3i110!4i256!2m3!1e0!2sm!3i692438032!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=85016"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: -256px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i159!3i110!4i256!2m3!1e0!2sm!3i692438032!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=68776"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: -256px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i159!3i109!4i256!2m3!1e0!2sm!3i692438129!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=51076"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: 0px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i160!3i108!4i256!2m3!1e0!2sm!3i692438129!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=97544"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: 256px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i161!3i108!4i256!2m3!1e0!2sm!3i692438032!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=26504"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: 512px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i162!3i108!4i256!2m3!1e0!2sm!3i692438032!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=111862"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                                <div
                                                    style="position: absolute; left: -256px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                                    <img draggable="false" alt="" role="presentation"
                                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i8!2i159!3i108!4i256!2m3!1e0!2sm!3i692438129!2m3!1e2!6m1!3e5!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0&amp;key=AIzaSyDIyd1PZSaAgpgWPCffbFBpJgtelh7B81k&amp;token=81304"
                                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <span id="2CDA60E5-0072-45C2-87E9-376F262DFEAA"
                                ...
                                <div></div>
                                <div>
                                    <div style="position: absolute; right: 0px; top: 0px;"><button type="button"
                                            class="btn btn-light fg-gps-btn m-2"><i
                                                class="fa fa-map-marker-alt"></i></button></div>
                                </div>
                                <div></div>
                                <div><button draggable="false" aria-label="Toggle fullscreen view"
                                        ...
                                        style="background: none rgb(255, 255, 255); border: 0px; margin: 10px; padding: 0px; text-transform: none; appearance: none; position: absolute; cursor: pointer; user-select: none; border-radius: 2px; height: 40px; width: 40px; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; overflow: hidden; top: 54px; right: 0px;"><img
                                        ...
                                        <div class="gmnoprint" data-control-width="40" data-control-height="40"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    title="Tilt map" type="button" class="gm-tilt gm-control-active"
                                ...
                                <div>
                                    <div
                                        ...
                                        <a target="_blank" rel="noopener"
                                            ...
                                            href="https://maps.google.com/maps?ll=25.146371,46.332092&amp;z=8&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3"
                                ...
                                <div>
                                    <div style="display: inline-flex; position: absolute; right: 0px; bottom: 0px;">
                                            ...
                                            <div draggable="false" class="gm-style-cc"
                                                ...
                                                <div
                                                    ...
                                                    <button draggable="false" aria-label="Map Data" title="Map Data"
                                                        ...
                                                        Data</button><span style="">Map data ©2024 Google</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="gmnoscreen">
                                        ...
                                        </div><button draggable="false" aria-label="Map Scale: 20 km per 36 pixels"
                                            title="Map Scale: 20 km per 36 pixels" type="button" class="gm-style-cc"
                                            aria-describedby="F5CAD1B9-917E-4B8A-B471-B89F797C60E5"
                                            ...
                                            <div
                                                ...
                                                <span>20 km&nbsp;</span>
                                                <div
                                                    style="position: relative; display: inline-block; height: 8px; bottom: -1px; width: 40px;">
                                                    <div
                                            ...
                                            </div><span id="F5CAD1B9-917E-4B8A-B471-B89F797C60E5"
                                        ...
                                        <div draggable="false" class="gm-style-cc"
                                            ...
                                            <div
                                                ...
                                                <a target="_blank" rel="noopener"
                                                    ...
                                                    dir="ltr"
                                                    href="https://www.google.com/maps/@25.1463712,46.3320919,8z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3"
                    ...
                    <div class="search-container position-absolute top-0 mt-3" style="left: 0; margin-left: 6px;">
                        <input id="pac-input" class="controls form-control" style="width: 200px;" type="text"
                            placeholder="Search for place">
                    </div>
                    <div dir="ltr"
                        class="position-absolute bottom-0 mb-3 text-light bg-dark bg-opacity-25 fs-10px p-1 rounded"
                        style="bottom: 0; left: 0; margin-left: 6px;">
                        <div>address: <span class="fg-location-map-address">mulham, Riyadh Region, Saudi Arabia</span>
                        </div>
                        <div>lat: <span class="fg-location-map-lat">25.146371208651</span></div>
                        <div>lng: <span class="fg-location-map-lng">46.332091859375</span></div>
                    </div>
                </div>
            </div>
        </div>
        <!--<button type="button" class="btn btn-primary fg-location-open" data-fg-lat="25.146371208651" data-fg-lng="46.332091859375"><i class="fa fa-map-marker-alt me-2"></i> Pick location</button>-->
    </div>
</div>
